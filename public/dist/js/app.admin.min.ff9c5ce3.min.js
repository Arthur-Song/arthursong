...
function autoLeftNav(){$(".tpl-header-switch-button").on("click",function(){$(".left-sidebar").is(".active")?($(window).width()>1024&&$(".tpl-content-wrapper").removeClass("active"),$(".left-sidebar").removeClass("active")):($(".left-sidebar").addClass("active"),$(window).width()>1024&&$(".tpl-content-wrapper").addClass("active"))}),$(window).width()<1024?$(".left-sidebar").addClass("active"):$(".left-sidebar").removeClass("active")}$(function(){var t=$("body").attr("data-type");console.log(t);for(key in pageData)key==t&&pageData[key]();storageLoad("SelcetColor")?$("body").attr("class",storageLoad("SelcetColor").Color):(storageSave(saveSelectColor),$("body").attr("class","theme-black")),autoLeftNav(),$(window).resize(function(){autoLeftNav(),console.log($(window).width())}),storageLoad("SelcetColor")||storageSave(saveSelectColor)});var pageData={index:function(){$("#example-r").DataTable({bInfo:!1,dom:"ti"});var t=echarts.init(document.getElementById("tpl-echarts"));option={tooltip:{trigger:"axis"},grid:{top:"3%",left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",boundaryGap:!1,data:["周一","周二","周三","周四","周五","周六","周日"]}],yAxis:[{type:"value"}],textStyle:{color:"#838FA1"},series:[{name:"新增用户",type:"line",stack:"总量",areaStyle:{normal:{}},data:[12,17,23,15,9],itemStyle:{normal:{color:"#1cabdb",borderColor:"#1cabdb",borderWidth:"2",borderType:"solid",opacity:"1"},emphasis:{}}}]},t.setOption(option)}};$(".tpl-skiner-toggle").on("click",function(){$(".tpl-skiner").toggleClass("active")}),$(".tpl-skiner-content-bar").find("span").on("click",function(){$("body").attr("class",$(this).attr("data-color")),saveSelectColor.Color=$(this).attr("data-color"),storageSave(saveSelectColor)}),$(".sidebar-nav-sub-title").on("click",function(){$(this).siblings(".sidebar-nav-sub").slideToggle(80).end().find(".sidebar-nav-sub-ico").toggleClass("sidebar-nav-sub-ico-rotate")});
function storageSave(e){localStorage.setItem(e.Name,JSON.stringify(e))}function storageLoad(e){return!!localStorage.getItem(e)&&JSON.parse(localStorage.getItem(e))}var saveSelectColor={Name:"SelcetColor",Color:"theme-black"};storageLoad("SelcetColor")?$("body").attr("class",storageLoad("SelcetColor").Color):(storageSave(saveSelectColor),$("body").attr("class","theme-black"));
